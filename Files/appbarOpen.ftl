          ...
          <li>
            ...
            <#list displayApps as display>
              ...
              <#if permission == true>
                ...
                <#else>
                 <!-- Original <li<#if selected> class="selected"</#if>><a href="${thisURL + externalKeyParam}"<#if uiLabelMap?exists>title="${uiLabelMap[display.description]}">"${uiLabelMap[display.title]}">${uiLabelMap[display.title]}<#else> title="${display.description}">${display.title}</#if></a></li> -->
                <!-- Add <icon> tag --> <li<#if selected> class="selected"</#if>><a href="${thisURL + externalKeyParam}"<#if uiLabelMap?exists>title="${uiLabelMap[display.description]}"><icon class="${uiLabelMap[display.title]}">${uiLabelMap[display.title]}</icon><#else> title="${display.description}">${display.title}</#if></a></li>
                </#if>
              </#if>
            </#list>
           </ul></li>
